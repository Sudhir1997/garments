...
export default class InnerCategory extends React.Component{
  ...
  <div className="card-body">
    ...
    <a target="_blank" href="https://api.whatsapp.com/send?phone=+91 9910299769&text=Hello,Sir I want to buy this https://picsum.photos/id/237/200/300" className={`btn btn-success ${styles.whatapplink}`}>WhatsApp To Buy
</a>
  </div>
</div>)
  }
